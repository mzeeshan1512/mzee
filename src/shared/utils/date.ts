const convertToRegionTime = (
  inputDate: Date | string,
  region: string = "Asia/Karachi"
) => {
...
const convertToDate = (dateString: string): Date => {
  ...
  if (month === undefined || isNaN(year) || month < 0 || month > 11) {
    throw new Error(
      'Invalid date string format. Expected format: "Jan-2023" or "01-2023"'
    );
  }
...
export { convertToRegionTime, formatDate, convertToDate, MONTHS_SHORT };
